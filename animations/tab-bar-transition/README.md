### Tab-bar and transitions

In this one we are going to learn how we can create a `tab-bar` navigation with some transitions in it. For that we are going to need the following packages that we will need to install
